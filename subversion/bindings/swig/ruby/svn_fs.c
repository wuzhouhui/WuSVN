...
_wrap_svn_fs_path_change3_t_path_get(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (struct svn_fs_path_change3_t *)(argp1);
  result =  ((arg1)->path);
  vresult = SWIG_NewPointerObj((svn_string_t *)memcpy((svn_string_t *)malloc(sizeof(svn_string_t)),&result,sizeof(svn_string_t)), SWIGTYPE_p_svn_string_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
